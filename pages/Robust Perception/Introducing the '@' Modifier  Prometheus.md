...
type: #clipping 
tags: #prometheus
source: https://prometheus.io/blog/2021/02/18/introducing-the-@-modifier/
author: Prometheus
---
> In Prometheus v2.25.0, we have introduced a new PromQL modifier `@`. Similar to how `offset` modifier lets you offset the evaluation of vector selector, range vector selector, and subqueries by a fixed duration relative to the evaluation time.
